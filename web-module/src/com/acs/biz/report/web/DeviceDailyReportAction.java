 ...
 * @author Eric
 */
public class DeviceDailyReportAction extends AbstractAction {
	...
	public String jsonData() {
		setRecordDate();
		List<Map<String, Object>> result = logDeviceDailyService.listByDeviceId_RecordDate(paraDeviceId, recordDateStart,
				recordDateEnd);
