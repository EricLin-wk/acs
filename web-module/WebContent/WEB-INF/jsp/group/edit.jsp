...
<div class="row-fluid">
	...
	<s:form action="save.do" method="post" id="formObj">
		<div class="box span12">
			...
			<s:hidden name="permissionName" id="pName"/>
			<table class="table table-bordered table-striped table-condensed">
				<tr>
					<th style="width: 15%">代码</th>
					<s:if test="%{obj.modifyDate != null}">
						<td>${obj.code}<s:hidden name="obj.code" id="pkey"/></td>
					</s:if>
					<s:else>
						<td><s:textfield name="obj.code" id="pkey" theme="simple"/></td>
					</s:else>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align: left"><s:select list="typeMenu" name="obj.type" listKey="key" listValue="value" theme="simple"/></td>
				</tr>
			</table>
			<div class="row-fluid">
