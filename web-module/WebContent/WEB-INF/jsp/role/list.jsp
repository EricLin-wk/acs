...
<s:if test="objList.size > 0">
	<table class="table table-bordered table-striped table-condensed">
		...
		<tbody>
			<c:forEach items="${objList}" var="role" varStatus="rows_index">
				<tr>
					<td><fmt:formatNumber pattern="0000" value="${rows_index.count + pager.currentPage*20}" /></td>
					<td class="center"><a href="view.do?paraId=${role.name}">${role.type.code}</a></td>
					<td class="center"><a href="view.do?paraId=${role.name}">${role.key}</a></td>
