...
$.formValidator = 
{
	...
	//驗證表單是否通過，正確返回settings[0],錯誤反迴對應的settings[i]
	...
	//對正規表達式進行驗證（目前只針對input和textarea）
...
$.fn.formValidator = function(cs) 
{
	...
	return this.each(function(e)
	{
		...
		if(srcTag == "input" || srcTag=="textarea")
		{
			...
			//註冊失焦點的事件。進行驗證，改變提示對象的文字和樣式；出錯就提示處理
