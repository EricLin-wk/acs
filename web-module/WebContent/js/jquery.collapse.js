...
!function($) {
  ...
  Collapse.prototype = {
    handleClick: function(e) {
      ...
      while(l--) {
        ...
        if(sections[l].$summary.hasClass("open")||sections[l].$summary.hasClass("hide")) {
          sections[l].toggle();
          break;
        }
      }
  ...
  Section.prototype = {
    ...
    _changeState: function(state, bypass) {
      ...
      _this.$summary.removeClass("open hide").addClass(state);
      _this.$details.attr("aria-hidden", state == "open");
