/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   Module Name          : com.acs.core.common.entity.SimplePager
   Module Description   :
...
public class SimplePager implements Serializable {
	...
	/** serialVersionUID */
	private static final long serialVersionUID = -435524604001605879L;
	...
	public long getEndRecord() {
		return (currentPage + 1) * pageRecord > totalSize ? totalSize : ((currentPage + 1) * pageRecord);
	}
