 ...
 */
@Entity
@Table(name = "acs_log_device_daily", uniqueConstraints = { @UniqueConstraint(columnNames = { "record_date",
		"device_id" }) })
public class LogDeviceDaily extends BaseEntity {

	private static final long serialVersionUID = 7018623866253607272L;
